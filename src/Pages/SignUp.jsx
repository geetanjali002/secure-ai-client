...
import toast from 'react-hot-toast';
import { useNavigate } from 'react-router-dom';
import { auth, googleProvider, fireDB } from '../Firebase/fireConfig';
import { createUserWithEmailAndPassword, signInWithPopup } from 'firebase/auth';
import { addDoc, collection, Timestamp } from 'firebase/firestore';
...
const Register = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-black">
            <div className="bg-gray-800 px-10 py-10 rounded-xl">
                <div>
                    <h1 className="text-center text-[#66D9D1] text-2xl mb-4 font-bold">
                        Signup
                    </h1>
                </div>
                <div>
                    <input
                        type="email"
                        name="email"
                        className="bg-gray-700 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg placeholder-gray-400 outline-none text-white"
                        placeholder="Email"
                        onChange={(e) => setEmail(e.target.value)}
                    />
                </div>
                ...
                <div className="flex justify-center mb-3 flex-col gap-2">
                    <button
                        className="bg-[#66D9D1] w-full text-black font-bold px-2 py-2 rounded-lg"
                        onClick={handleEmailRegistration}
                    >
                        Signup with Email
                    </button>
                ...
                <div className="flex gap-3">
                    ...
                    <h2
                        className="cursor-pointer text-[#66D9D1] font-bold underline"
                        onClick={() => navigate("/login")}
                    >
                        Login
                    </h2>
