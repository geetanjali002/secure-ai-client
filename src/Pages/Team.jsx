    ...
    <div className="max-w-3xl mx-auto px-4 py-8 min-h-screen mt-16">
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col max-w-full">
          ...
          <a
            href="https://www.linkedin.com/in/arushi-karal2002"
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col max-w-full">
          ...
          <a
            href="https://www.linkedin.com/in/muskan-damani-9ab82a24b"
            className="text-blue-500"
          >
            <FaLinkedin className="text-blue-700" size={30}/>
          </a>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col max-w-full">
          ...
          <a
            href="https://www.linkedin.com/in/divyanshi-pareta-343781249"
            className="text-blue-500"
          >
            <FaLinkedin className="text-blue-700" size={30}/>
          </a>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col max-w-full">
          ...
          <a
            href="https://www.linkedin.com/in/devvrat-singh-rathore-498726221/"
            className="text-blue-500"
          >
            <FaLinkedin className="text-blue-700" size={30}/>
          </a>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col max-w-full">
          ...
          <a
            href="https://www.linkedin.com/in/geetanjali02"
            className="text-blue-500"
          >
            <FaLinkedin className="text-blue-700" size={30}/>
          </a>
